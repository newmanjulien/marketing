...
//   npm run add:success-room:mutual-success-plan -- <room-slug>
//
...
// success plan content for the given room.
...
if (!slug) {
  console.error("Usage: npm run add:success-room:mutual-success-plan -- <room-slug>");
  process.exit(1);
}
...
await enableSuccessRoomSection({
  slug,
  resourceSlug: "mutual-success-plan",
  planAccordions,
});
