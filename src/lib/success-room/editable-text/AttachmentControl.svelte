<script lang="ts">
  ...
  const attachmentLinkClasses =
    'block truncate text-[13px] font-normal leading-[1.2] text-stone-700 transition-colors duration-150 hover:text-stone-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-900/20';
...
<div class="grid gap-[8px]">
  ...
  {#if error}
    <p
      class="m-0 text-[13px] font-book leading-[1.35] text-red-700"
      aria-live="polite"
    >
      {error}
    </p>
