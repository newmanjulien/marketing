<script lang="ts">
  ...
  const inputClasses =
    'h-[42px] w-full rounded-[8px] border border-stone-200 bg-white px-[12px] font-body text-[14px] font-book leading-none text-stone-800 outline-none transition-colors duration-150 placeholder:text-stone-400 focus:border-stone-300 focus:ring-2 focus:ring-stone-900/20';
  const labelClasses = 'grid gap-[7px] text-[13px] font-book leading-none text-stone-500';
