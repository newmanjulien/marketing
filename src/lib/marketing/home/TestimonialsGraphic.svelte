...
<div class="flex flex-col gap-[34px] sm:gap-[40px]">
  {#each testimonials as testimonial (testimonial.quote)}
    <figure class="border-l-[2px] border-stone-200 pl-[18px] sm:pl-[20px]">
      <blockquote
        class="font-heading text-[18px] font-book leading-[1.42] text-stone-700 sm:text-[20px]"
      >
        "{testimonial.quote}"
      </blockquote>

      <figcaption class="mt-[12px] text-[14px] font-book leading-none text-stone-400 sm:text-[15px]">
