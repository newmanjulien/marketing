...
export const consulting = {
  ...
  revenueOutcomeParagraphs: [
    ...
    'You open new accounts and expand existing ones without prospecting, and referrals flow both ways. Your alliances become a reliable source of new project revenue'
  ],
  networkResults: {
