  ...
  scenarios: [
    {
      ...
      description:
        'Overbase turns the work your colleagues in other departments are doing into easy upselling. We securely analyze client documents to spot hidden opportunities. All by text message',
